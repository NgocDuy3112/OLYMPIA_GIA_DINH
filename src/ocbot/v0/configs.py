...
PING_AUDIO_PATH = os.environ.get("PING_AUDIO_PATH")
VCNV_AUDIO_PATH = os.environ.get("VCNV_AUDIO_PATH")
PREPARE_TO_PING_AUDIO_PATH = os.environ.get("PREPARE_TO_PING_AUDIO_PATH")
CHANGE_ANSWER_AUDIO_PATH = os.environ.get("CHANGE_ANSWER_AUDIO_PATH")
