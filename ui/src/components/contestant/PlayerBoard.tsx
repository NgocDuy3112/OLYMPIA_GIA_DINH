    ...
    return (
        ...
        >
            <div className="flex justify-between items-center w-full">
                <p className="text-[20px] font-bold uppercase truncate text-left max-w-[80%]">
                    {player.name}
                </p>
            ...
            <div className="mt-2 text-center min-h-10 flex flex-col items-center justify-center w-full mx-auto">
                <p className={`px-2 rounded-md text-[18px] font-bold wrap-break-word ${isAnswered ? answerClasses : 'text-white'}`}>
                    {displayAnswer}
                </p>
